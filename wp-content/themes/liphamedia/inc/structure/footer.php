...
if ( ! function_exists( 'storefront_credit' ) ) {
	...
	function storefront_credit() {
		...
		<div class="site-info">
			...
			<br /> <?php printf( __( '%1$s designed by %2$s.', 'Liphamedia.com' ), 'Ecommerce', '<a href="http://www.liphamedia.com" alt="Premium WordPress Themes & Plugins by Liphamedia" title="Premium WordPress Themes & Plugins by Liphamedia" rel="designer">Liphamedia</a>' ); ?>
			<?php } ?>
		</div><!-- .site-info -->
		<?php
	}
