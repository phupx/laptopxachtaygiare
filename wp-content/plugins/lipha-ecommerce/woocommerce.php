<?php
/**
 * Plugin Name: Liphamedia Shop
 * Plugin URI: http://www.liphamedia.com/lipha-shop/
 * Description: An e-commerce toolkit that helps you sell anything. Beautifully.
 * Version: 2.5.5
 * Author: Liphamedia Shop
 * Author URI: http://www.liphamedia.com
 * Requires at least: 4.1
 * Tested up to: 4.3
 *
 * Text Domain: liphashop
 * Domain Path: /i18n/languages/
 *
 * @package Liphamedia
 * @category Core
 * @author Pham Xuan Phu
 */
if ( ! defined( 'ABSPATH' ) ) {
...
/**
 * Main Liphamedia Shop Class.
 *
 * @class Liphamedia Shop
 * @version	2.5.0
 */
final class WooCommerce {

	/**
	 * Liphamedia Shop version.
	 *
	 * @var string
	 */
	...
	/**
	 * Main Liphamedia Instance.
	 *
	 * Ensures only one instance of Liphamedia is loaded or can be loaded.
	 *
	 * @since 2.1
	 * @static
	 * @see WC()
	 * @return Liphamedia - Main instance.
	 */
	...
	/**
	 * Function used to Init Liphamedia Template Functions - This makes them pluggable by plugins and themes.
	 */
	...
	/**
	 * Init Liphamedia when WordPress Initialises.
	 */
	 ...
	 *
	 * Locales found in:
	 *      - WP_LANG_DIR/Liphamedia/Liphamedia-LOCALE.mo
	 *      - WP_LANG_DIR/plugins/Liphamedia-LOCALE.mo
	 */
